...
func (d *LXCConfigDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = dschema.Schema{
		Description: "Reads the current TrueNAS SCALE LXC service configuration. Takes no arguments: there " +
			"is exactly one LXC configuration per TrueNAS system. Requires TrueNAS SCALE 26.0 or later (see " +
